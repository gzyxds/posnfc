...
const bareMetalFeatures = [
  ...
  {
    name: '高性能架构',
    description: '企业级硬件配置，99.9% 的硬件可用性保障，专业运维团队7x24小时监控，确保业务稳定运行。',
    icon: DocumentTextIcon,
  },
  {
    name: '安全防护',
    description: '物理级安全隔离，包括硬件防火墙、访问控制、数据加密和安全审计，全方位保护您的数据安全。',
    icon: LockClosedIcon,
  },
]
...
const rightLeftFeatures = [
  ...
  {
    name: '安全加固',
    description: '提供系统安全加固、防火墙配置、安全补丁管理等服务，为您的物理服务器提供全方位的安全保护。',
    icon: LockClosedIcon,
  },
  {
    name: '数据保护',
  ...
  const bareMetalVideoSlide = [
    {
      ...
      title: '独立物理服务器',
      subtitle: '重新定义专属计算',
      description: '体验下一代独立物理服务器，让专属硬件资源为您的业务发展提供强大支持。从裸金属部署到应用优化，独立服务器让高性能计算变得前所未有的简单。',
        ...
        <div className="bg-gray-50 min-h-screen">
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-8 py-6">
              <h1 className="text-2xl font-bold text-gray-900">独立物理服务器专区</h1>
