...
import { ChevronRightIcon, CreditCardIcon } from '@heroicons/react/20/solid'
import {
...
const advantages: Advantage[] = [
  {
    title: '交易处理能力',
    description: '拉卡拉POS机支持银联、微信、支付宝等多种支付方式，交易处理快速稳定',
    stats: '99.9%',
    unit: '成功率',
    icon: BoltIcon,
  },
          ...
          <div className="space-y-4 text-center sm:space-y-6 lg:text-left">
            ...
            <div className="space-y-2 sm:space-y-3">
              <p className="mx-auto max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg lg:mx-0 dark:text-gray-300">
                拉卡拉官网提供专业的POS机办理服务，支持电签POS、移动收款、刷脸支付等多种收款方式，银联正规认证，资金安全有保障
              </p>
...
function ScenariosSection(): JSX.Element {
  ...
  const scenarioData = {
    ...
    bankCardPayment: {
      ...
      icon: CreditCardIcon,
      features: [
        { icon: PencilIcon, title: '芯片卡支付', desc: 'IC芯片卡安全支付，防伪性强' },
...
/**
 * 核心功能展示组件 - 简洁版设计
 * 展示拉卡拉POS机产品的核心功能和特性，采用简洁清晰的设计风格
 * 特点：简洁布局、清晰层次、易于阅读
 */
  ...
  const coreFeatures: CoreFeature[] = [
    {
      name: '电签POS机',
      description:
        '拉卡拉电签POS机，支持银联、微信、支付宝等多种支付方式，交易安全快捷，适合各类商户使用！',
      icon: BoltIcon,
    ...
    },
    {
      name: '智能终端',
      description:
        '智能收银终端，集收款、会员管理、库存管理于一体，助力商户数字化经营升级。',
      icon: SparklesIcon,
...
// 数字人页面主组件
export default function LklPage(): JSX.Element {
  return (
    <>
      <Header />
