...
interface FeatureCard {
  ...
  lastUpdate: { date: string; dateTime: string }
  icon: React.ComponentType<React.SVGProps<SVGSVGElement>>
}
...
const featureCards: FeatureCard[] = [
  {
    ...
    status: 'Active',
    lastUpdate: { date: 'December 15, 2024', dateTime: '2024-12-15' },
  ...
  },
  {
    ...
    status: 'Active',
    lastUpdate: { date: 'December 10, 2024', dateTime: '2024-12-10' },
    icon: AcademicCapIcon,
  },
  {
    id: 3,
    ...
    status: 'Beta',
    lastUpdate: { date: 'December 12, 2024', dateTime: '2024-12-12' },
    icon: FaceSmileIcon,
  },
  {
    id: 4,
    ...
    status: 'Active',
    lastUpdate: { date: 'December 8, 2024', dateTime: '2024-12-08' },
    icon: CpuChipIcon,
  },
]
                ...
                <li key={feature.id} className="overflow-hidden rounded-xl outline-1 outline-gray-200 hover:outline-gray-300 transition-all duration-200 hover:shadow-lg">
                  <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6">
                    ...
                    <Menu as="div" className="relative ml-auto">
                      <MenuButton className="relative block text-gray-400 hover:text-gray-500 transition-colors">
                      ...
                      <MenuItems
                        transition
                        className="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg outline outline-gray-900/5 transition data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
                      >
                        <MenuItem>
                          <a
                            href="#"
                            className="block px-3 py-1 text-sm leading-6 text-gray-900 data-[focus]:bg-gray-50 data-[focus]:outline-none"
                          >
                            查看详情<span className="sr-only">, {feature.name}</span>
                          </a>
                        </MenuItem>
                        <MenuItem>
                          <a
                        ...
                        <MenuItem>
                          <a
                            ...
                            className="block px-3 py-1 text-sm leading-6 text-gray-900 data-[focus]:bg-gray-50 data-[focus]:outline-none"
                          >
                            立即体验<span className="sr-only">, {feature.name}</span>
                          </a>
                        </MenuItem>
                      </MenuItems>
                    </Menu>
                    ...
                    <dl className="-my-3 divide-y divide-gray-100 text-sm leading-6">
                      <div className="flex justify-between gap-x-4 py-3">
                        ...
                        <dd className="text-gray-700">
                          <time dateTime={feature.lastUpdate.dateTime}>
                            {feature.lastUpdate.date}
                          </time>
                        </dd>
                      </div>
                      <div className="flex justify-between gap-x-4 py-3">
                        ...
                        <dd className="flex items-start gap-x-2">
                          ...
                          {feature.status === 'Beta' && (
                            <div className="rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-700 ring-1 ring-inset ring-yellow-600/20">
                              {feature.status}
                            </div>
                          )}
