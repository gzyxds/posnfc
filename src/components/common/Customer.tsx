      ...
      <Container>
        ...
        <div className="flex flex-col items-start gap-8 lg:grid lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-2 w-full lg:order-1">
              ...
              <div className="scrollbar-hide flex space-x-2 overflow-x-auto pb-2">
                {customers.map((customer, index) => (
                  <button
                    ...
                    className={`flex-shrink-0 rounded-none px-4 py-2 text-sm font-medium transition-all duration-200 ${
            ...
            {/* 移动端：当前选中客户的详细信息 */}
            <div className="mb-6 block rounded-none bg-blue-600 p-6 text-white lg:hidden">
            ...
            <div className="hidden min-h-[450px] space-y-1 lg:flex lg:flex-col">
              {customers.map((customer, index) => (
                <button
                  key={customer.id}
                  onClick={() => setActiveCustomer(customer.id)}
                  className={`w-full flex-1 rounded-none transition-all duration-200 ${
                    activeCustomer === customer.id
          ...
          <div className="order-1 w-full lg:order-2">
            <div className="h-[250px] overflow-hidden rounded-none bg-gray-100 sm:h-[300px] md:h-[350px] lg:h-[450px]">
              <Image
