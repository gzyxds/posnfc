      ...
      <Container>
        <div className="flex justify-between items-center mb-8">
          ...
          <a href="#" className="text-indigo-600 hover:text-indigo-500 flex items-center text-sm font-medium">
            了解更多 <ChevronRightIcon className="h-4 w-4 ml-1" />
          </a>
        </div>
          ...
          <div className="h-[400px] overflow-y-auto pr-4">
            {customers.map((customer) => (
              ...
              >
                ...
                >
                  <span className={`text-lg font-medium ${activeCustomer === customer.id ? 'text-indigo-600' : 'text-gray-900'}`}>
                    {customer.name}
                  </span>
                ...
                {activeCustomer === customer.id && (
                  <div className="px-6 pb-4">
                    <p className="text-gray-600 text-base">{customer.content}</p>
                  </div>
                )}
              </div>
            ))}
            ...
            {currentCustomer.media.type === 'image' ? (
              ...
              <div className="w-full h-full relative">
                ...
                <div className="absolute bottom-4 right-4 flex space-x-2">
                  <button className="p-1 bg-black/50 text-white">
